    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ __('Struktur Organisasi - Lab NCS') }}
            </h2>
        ...
        <div class="max-w-7xl mx-auto sm:px-4 lg:px-6 space-y-4">
            ...
            <div class="bg-gradient-to-r from-green-600 to-green-800 dark:from-green-800 dark:to-green-900 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-bold mb-1">Kelola Struktur Organisasi</h3>
                            <p class="text-sm text-green-100">Kelola konten Struktur Organisasi Lab NCS</p>
                        </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <p class="text-gray-600 dark:text-gray-400">Konten halaman Struktur Organisasi akan ditampilkan di sini.</p>
                </div>
            </div>
